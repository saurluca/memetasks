...
<template>
  <form @submit.prevent="addTodo" class="mb-4">
    <div class="flex">
      ...
      <button
        type="submit"
        class="px-4 py-2 bg-blue-500 dark:text-slate-200 rounded-r-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-300"
      >
        Add
      </button>
    </div>
