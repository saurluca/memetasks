  ...
  <form @submit.prevent="addTodo" class="mb-4">
    <div class="flex">
      <input
        ...
        class="flex-grow px-4 py-2 border bg-slate-50 text-black rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-colors duration-300"
      />
      <button
        type="submit"
