...
// Add PostHog script to the head
useHead({
  script: [
    {
      innerHTML: `
    ...
    posthog.init('phc_JfqkPu57A1GOrFW8UQU7vbxwY7l5y2gUj7l16ZJBpRo', {api_host: 'https://eu.i.posthog.com'})
      `,
      type: 'text/javascript',
    },
  ],
  __dangerouslyDisableSanitizersByTagID: {
    'nuxt-head-script-0': ['innerHTML'],
  },
});
</script>
