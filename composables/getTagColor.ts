...
export const getTagColorActive = (tagId: string) => {
    ...
    const colorIndex = tagId.charCodeAt(0) % 5
    const colorVariants = {
        0: 'bg-rose-500 text-white dark:bg-rose-600 dark:text-rose-100',
        1: 'bg-blue-500 text-white dark:bg-blue-600 dark:text-blue-100',
        2: 'bg-green-500 text-white dark:bg-green-600 dark:text-green-100',
        3: 'bg-orange-500 text-white dark:bg-orange-600 dark:text-orange-100',
        4: 'bg-fuchsia-500 text-white dark:bg-fuchsia-600 dark:text-fuchsia-100',
    }
    return colorVariants[colorIndex]
}